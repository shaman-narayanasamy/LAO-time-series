...
sub usage {
    ...
    print "Usage: get_gc_content.pl <fasta file> <output file>\n";
    print "This program takes a fasta file as it's first parameter and the output file name as the second parameter.\n\n";
    ...
    print "Original: Jennifer Meneghin\n";
    print "July 23, 2009\n\n";
    ...
    print "Added second parameter to specify output file name";
}
